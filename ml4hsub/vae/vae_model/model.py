...
prior_network = nn.Sequential(
    # MemoryLayer('#0'),
    nn.Conv2d(1, 16, 1),
    ResBlock(16, 16), ResBlock(16, 16), ResBlock(16, 16), ResBlock(16, 16),
    # MemoryLayer('#1'),
    nn.AvgPool2d(2, 2),
    ...
    ResBlock(512, 256), ResBlock(512, 256),
    ResBlock(512, 256), ResBlock(512, 256),
    # MemoryLayer('#8'),
    nn.AvgPool2d(2, 2), nn.Conv2d(512, 512, 1),
    ResBlock(512, 256), ResBlock(512, 256),
    ResBlock(512, 256), ResBlock(512, 256),
    # MemoryLayer('#9'),
    nn.AvgPool2d(2, 2), nn.Conv2d(512, 512, 1),
...
generative_network = nn.Sequential(
    ...
    nn.Conv2d(256, 256, 1), nn.Upsample(scale_factor=2),

    # MemoryLayer('#9', True), nn.Conv2d(768, 256, 1),

    ResBlock(256, 128), ResBlock(256, 128),
    ResBlock(256, 128), ResBlock(256, 128),
    nn.Conv2d(256, 256, 1), nn.Upsample(scale_factor=2),
    # MemoryLayer('#8', True), nn.Conv2d(768, 256, 1),
    ResBlock(256, 128), ResBlock(256, 128),
    ResBlock(256, 128), ResBlock(256, 128),
    nn.Conv2d(256, 256, 1), nn.Upsample(scale_factor=2),
    ...
    ResBlock(32, 32), ResBlock(32, 32), ResBlock(32, 32), ResBlock(32, 32),
